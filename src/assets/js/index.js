...
class Splash {
    ...
    async startAnimation() {
        let splashes = [
            { "message": "Je suis en vie... pour l'instant ! 👀", "author": "Booftoo" },
            { "message": "⚡ Code en action ! Salut, humain. 👋", "author": "Booftoo" },
            { "message": "Linux ? C’est pas juste un OS… c’est une philosophie ! 🐧", "author": "Booftoo" }
        ];
